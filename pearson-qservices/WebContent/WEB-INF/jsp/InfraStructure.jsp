...
<p > Connectivity Testing to validate the quality and extensiveness of infrastructure networks <br>
Fail Over testing to assure that the secondary infrastructure component is automatically engaged without disrupting the business-as-usual when the primary fails <br>
Load balancing to  optimize infrastructure utilization and increase infrastructure reliability. </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
<p> IBM Message Broker allows business information to flow between disparate applications across multiple hardware and software platforms
IBM Message Queue prevents transfer of duplicate and redundant messages between the infrastructure components which arise due to errors and other network related issues.<br>
RFHUtil is a utility program for ad-hoc testing of message flows using a wide variety of message manipulations. <br>
SoapUI is used to create advanced Performance Tests and to run Automated Functional Tests.<br>
Oracle SQL developer is used to test connections between multiple databases and  schemas.<br>
Selenium leverages automation to support  continuous Integration of build infrastructure.<br></p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
<p> Recommended for applications using technologies such as Cloud and Virtualization involving multidimensional complexities <br>
Infrastructure testing should be used in the event of new hardware deployment or hardware integration or migration of infrastructure physically from one data center to another.
</p>

<h2 style="color:#3399FF">Project Names where services were offered</h2>
<p>1. SII Infrastructure - Message Logger<br>
2. SII Infrastructure - Exception Handler</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
<p>1.  Messages can be Queued for sometime before getting processed.<br>
2. Messages can be split/merged during the message flow.<br>
3. Messages can be manipulated, if necessary<br>
4. Errors can be logged in the database for future reference.
</p>
