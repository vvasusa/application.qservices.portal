...
<title>Our Services - Pearson Q-service Portal</title>
...
<div class="container">
 ...
 <li id=""><a id="close" class="close" href="${pageContext.request.contextPath}/logout/">Logout</a> 
    ...
    <div class="header">
        ...
        <div class="submenu">
        <ul id="sub-nav">
                    <li><a href="${pageContext.request.contextPath}/services/">Services Home</a></li>
                    <li><a href="${pageContext.request.contextPath}/sub_serv/" class="selected">E-Commerce</a></li>
                    <li><a href="${pageContext.request.contextPath}/sub_serv/">PSD 2 HTML</a></li>
    ...
    <div class="page">
    <h2>Our Services / Sub-Services Page</h2>
        ...
        <div class="span-18">
            ...
            <div class="boxed_page">
                ...
                <!--#PAGE INTRO#-->
                <!--Brief Info -->
                <p><b>Since all pages under Services will look the same, they all link to the same page.</b> Lorem ipsum dolor 
                sit amet contetur adipisicing elit, sed do eiusmodarel tempor incididunt ut labore 
                et dolor magna aliqua. Ut enim ad minimilo veniam, quis nostrud exercitational ullamco lorem ipsum</p>
                <p><b>Bob Smith</b> of <i>CyberSmither</i> had this to say about our E-Commerce package,</p>
                
                <blockquote><p> &quot;This is a Blockquote - Lorem Ipsum Sit Dolor Amet Lorem ipsum dolor 
                sit amet contetur adipisicing elit, sed do eiusmodarel tempor incididunt ut labore 
                et dolor magna aliqua. Ut enim ad minimilo veniam, quis nostrud exercitational ullamco lorem ipsum. &quot; </p> </blockquote>
                ...
                <h5>Some Companies Who have used our E-Commerce Package</h5>
            ...
            <hr class="space" />
            	...
            	<ul id="case_preview">
                    <li><a href="${pageContext.request.contextPath}/img/port/case/large.jpg" class="lightbox"><img src="./img/port/sub_comp.jpg" alt="" /></a></li>
                    <li><a href="${pageContext.request.contextPath}/img/port/case/large.jpg" class="lightbox"><img src="./img/port/sub_comp.jpg" alt="" /></a></li>
                    <li><a href="${pageContext.request.contextPath}/img/port/case/large.jpg" class="lightbox"><img src="./img/port/sub_comp.jpg" alt="" /></a></li>
                    <li><a href="${pageContext.request.contextPath}/img/port/case/large.jpg" class="lightbox"><img src="./img/port/sub_comp.jpg" alt="" /></a></li>
                    <li><a href="${pageContext.request.contextPath}/img/port/case/large.jpg" class="lightbox"><img src="./img/port/sub_comp.jpg" alt="" /></a></li>
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eius tempor incididunt ut labore et dolore magna aliqua.
                Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris Nullam pulvinar ultri malasuada quisque. Lorem ipsum dolor
                sit amet, consectetur adipisicing elit, sed do eius tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim 
                veniam, quis nostrud exercitation ullamco laboris Nullam pulvinar ultri malasuada quisque. </p>
        ...
        <div class="span-6 last">
            ...
            <!--meta info-->
            <div class="meta">11 / 14 / 09 &nbsp;|&nbsp; <span class="color">design, html</span></div>
            <!--brief intro-->
            <p> Lorem ipsum dolor sit amet contetur adipisicing elit, sed do eiusmodarel tempor incididunt...</p>
            <!--close entry-->
            ...
            <h2>PDF Available</h2>
            <!--text-->
            <p> Lorem ipsum dolor sit amet contetur adipisicing elit, sed do eiusmodarel tempor incididunt ut labore 
                et dolor magna aliqua. Ut enim ad minimilo veniam, quis nostrud exercitational ullamco lorem ipsum</p>
            </div><!--boxed close-->
