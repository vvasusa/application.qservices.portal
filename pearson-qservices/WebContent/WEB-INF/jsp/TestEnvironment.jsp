...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="service" value="TESTeNVIRONMENT" /> 
						<input type="hidden" name="serviceID" value="TE01" /> 
...
<div class="span-24">
<H1 style="color:#900000">TestEnvironment Management</H1>
	
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>


<p >Establish specific environments for various phases of testing and manage their usage.<br>
Create an inventory of available test environments on various platforms and ensure timely availability of test environment / data for testing. <br>
Manage existing test environments, build new test environments and provide additional capacity on demand. <br>
Establish a testing calendar to communicate and co-ordinate environment management across different teams. <br>
Refresh the environment with production data on a periodic basis to enable effective testing. </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
<p> 	
Test Environment Management Services (TEMS) is a tool agnostic framework which helps organizations to address common test environment issues and achieve efficiencies in demand fulfillment, capacity utilization and environment availability <br> 
(or)<br>
New Service Offering. Hence not applicable</p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
<p> Applications facing frequent environment downtime impacting the testing timelines. <br>
Organizations which suffer from delays in testing projects due to improper scheduling of tests. <br> 
Applications which are highly critical and complex having longer release cycle time.
</p>
