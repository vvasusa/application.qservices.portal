...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="service" value="TESTDATA" /> 
						<input type="hidden" name="serviceID" value="TD15" /> 
...
<div class="span-24">
<H1 style="color:#900000">TestData Management</H1>
	
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>


<p >Define test data strategy to standardize test data creation and maintenance processes to improve test data quality and re-usability factor. <br> 
Define standard guidelines for test data creation and maintenance. <br>
Create a test data repository and test data management techniques at the organization level. <br>
Create processes for updating the test data repository, synchronize the test data repository across all test environments and publish across the QA Organization. <br>
Streamline test data management & periodically audit the function. </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
<p> 	
 Accelerate reuse of policies by creating a mechanism to copy data from one environment to another.<br>
Effective Manual Searching to improve tester's ability to search for required data by making ad-hoc (Business Objects) data searching available in  test environments. <br>
(or)<br>
New Service Offering. Hence not applicable></p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
<p> Projects in which  instances of data security violation are observed <br>
Distributed applications requiring test data to be created and synchronized across multiple systems. <br>
To avoid accessing production systems to insert, update or delete test data. <br>
To ensure data availability before the start of test execution, avoiding delays in the testing timelines and ensuring proper Back-up and recovery procedures for test data.
</p>

<h2 style="color:#3399FF">Project Names where services were offered</h2>
<p> New Service Offering. Hence not applicable</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
<p>New Service Offering. Hence not applicable
</p>
