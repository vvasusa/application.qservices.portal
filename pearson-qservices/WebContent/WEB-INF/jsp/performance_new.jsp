...
<%-- 			<div class="span-14 colborder">
 ...
 --%>
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						...
						<input type="hidden" name="serviceID" value="PR12" /> 
		...
		<h3></h3>
			<p>	
				<font size="2px" >
				Ensure your application's performance meets customer expectations
			...
			<ul >
				<li >
				&bull; Convert the business requirements into measurable performance requirements, determine required test volume to conduct tests using robust & tool agnostic performance testing framework 
				
				</li >
				<li >
				 &bull; Execute tests under varying workload conditions to assess the system thresholds
				 
				</li>
				<li >
				&bull;  High Quality procedures and guidelines for performance testing using sophisticated templates 
				
				</li >
				<li >
				&bull;  Perform static code reviews, dynamic code profiling and early performance engineering at unit or component level by focusing on NFR principles
				
				</li >
				<li >
				&bull;  Analyze performance test results and recommend or implement fixes to improve the performance of the system
			...
			<ul >
				<li >
				&bull; Identify the impact of a particular system after the increase in the volume of user community & data
				
				</li >
				<li >
				&bull; Assess production readiness by evaluating against performance criteria and find the source of performance problems
				
				</li >
				<li >
				&bull; Compare performance characteristics of multiple systems or system configurations
				
				</li >
				<li >
				&bull; Identify performance bottlenecks early in the development lifecycle for business critical applications
			...
			<ul >
				<li >
				&bull;  HP Performance center to create scenarios and monitor statistics while running the performance scripts. 
				
				</li >
				<li >
				&bull;  Performance testing Framework to define standards and activities for each phase of performance testing
				
				</li >
				<li >
				&bull;  JMeter and Jenkins integration for running Performance test scripts
				
				</li >
				<li >
				&bull;  SOAP UI Smart bear tool for web services testing
				
				</li >
				<li >
				&bull;  New Relic for monitoring web and mobile applications
				
				</li >
				<li >
				&bull;  SAAVIS monitoring tool for web applications
			...
			<ul>
			    <li >
				&bull; Requirements were gathered and discussed upfront in the product life cycle to assure performance needs are identified and tested at appropriate time across all executed projects
				
				</li >
				  <li >
				&bull; Identified issues in 'Simplified' while testing SSO and ensured that the fixes were provided on time
				
				</li >
				  <li >
				&bull; Identified and analyzed issues with 'elasticpath APIs' during performance testing to ensure the same are fixed before production rollout
				
				</li >
				  <li >
				&bull; Identified issues with Composite tool during performance testing of and ensured that Composite provided fixes that are necessary to achieve the SLAs defined
				
				</li >
				  <li >
				&bull; Provided solutions successfully to conduct batch/data performance testing
				...
				<div class="span-16 last">
					...
					<ul id="footer-nav">
						<li><a href="${pageContext.request.contextPath}/index/">Home</a>
							|</li>
						<li><a href="${pageContext.request.contextPath}/services/">My Services</a>
							|</li>
