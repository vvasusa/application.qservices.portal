...
<title>Portfolio / Web Design Entries - Pearson Q-service Portal</title>
...
<script type="text/javascript"> 
 // Background color animation 
        $(document).ready(function(){
                $(".port_web_img img").hover(function() {
 ...
 <li id=""><a id="close" class="close" href="${pageContext.request.contextPath}/logout/">Logout</a> 
    ...
    <div class="header">
        ...
        <ul id="sub-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/web/" class="selected">Web Design</a></li>
    ...
    <div class="page">
    <h2>Portfolio / Web Design Entries</h2>
        ...
        <!--Declare 550px width last-->
        <div class="span-14 last">
        	<div class="port_web_img">
            <!--Large Case Entry Image-->
            <img src="./img/port/generic.jpg" alt="" />
    		</div>
            <!--case close-->
        </div>
        <!--550px width close-->
