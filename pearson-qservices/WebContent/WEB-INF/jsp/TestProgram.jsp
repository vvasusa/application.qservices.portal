...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="service" value="TESTPROGRAM" /> 
						<input type="hidden" name="serviceID" value="TP02" /> 
...
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>
	...
	<p >  As a Test consulting partner provide support in developing Test estimates, Test Strategy, Test Work Plan, Test Schedule
<br>Provide guidance through testing process, process improvement recommendations to overcome testing challenges.<br>
Provide guidance for defining the quality validation process and quality gates.<br> 
Assist with activities, deliverables, risks, dependencies associated with testing, as needed.<br>
Provide templates, checklists, testing artifacts, as needed.<br>
Provide packaged solution to optimize QA cost and to drive faster time-to-market.
 </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
	<p> Experienced Quality management team on product life cycle couple with  Templates, guidelines & 
	checklists to ensure adequate test coverage for functional and non-functional requirements.<br>
Management team equipped with technical knowledge,
 accelerators and cost effective tools to automate test design and execution for achieving faster time to market.<br>
Usage of effective Risk Management techniques to successfully deliver projects
.</p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
	<p>Programs / Projects with an objective to build quality management practices with an aim to deliver quality product to the market.<br>
 Experience and leadership to steer the quality goals of the organization / project<br>
Expertise to bring in best practices and standards to achieve quality output
.
		</p>

<h2 style="color:#3399FF">Project Names where services were offered</h2>
	<p> 1. Projects across Pearson Technology<br>
2. Wall Street English etc
</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
	<p>Projects delivered with Zero Production Defects in 2013 are : <br>
1.CCSS 2-12<br>
2.K1, Pearson college<br>
3.Open Ideas<br>
4.A&I, DoeC<br>
5.ICOM 1.3<br>
