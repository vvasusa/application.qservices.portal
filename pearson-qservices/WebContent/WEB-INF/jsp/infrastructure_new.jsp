...
<body>
	...
	<div class="box1"> 
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						...
						<input type="hidden" name="serviceID" value="IN08" /> 
		...
		<!-- ******************************************************************************** -->
		<div class="span-24">
			<p>	<h2 style="color: black">INFRASTRUCTURE</h2> 
				<font size="2px" >
			...
			<ul >
				<li >
				&bull; Connectivity Testing to validate the quality and extensiveness of infrastructure networks 
				
				</li >
				<li >
				 &bull; Fail Over tests to assure that the secondary infrastructure component is automatically engaged without disrupting the business-as-usual when the primary fails 
				 
				</li>
				<li >
				&bull;  Load balancing to optimize infrastructure utilization and increase infrastructure reliability
				
				</li >
				<li >
				&bull;  Functionality of the system / hardware when integrated with up-stream and down-stream systems
			...
			<ul >
				<li >
				&bull; Applications using technologies such as Cloud and Virtualization involving multidimensional complexities 
				</li >
				<li >
				&bull; In the event of new hardware deployment or hardware integration or migration of infrastructure physically from one data center to another
				</li >
			...
			<ul >
				<li >
				&bull;  IBM Message Broker to enable business information flow between disparate applications across multiple hardware and software platforms
				
				</li >
				<li >
				&bull;  IBM Message Queue to prevent transfer of duplicate and redundant messages between the infrastructure components 
				
				</li >
				<li >
				&bull;  RFHUtil utility program for ad-hoc testing of message flows using a wide variety of message manipulations 
				
				</li >
				<li >
				&bull;  SoapUI web services testing tool to automate functional testing 
				
				</li >
				<li >
				&bull;  Oracle SQL developer to test connections between multiple databases and schemas
				
				</li >
				<li >
				&bull;  Selenium to support continuous Integration of build infrastructure using automation
			...
			<ul>
			    <li >
				&bull; Executed various tests like queuing messages, split/merge the messages etc. for certain duration before processing to ensure failover and load balancing functionality are exercised
				</li >
				<li >
				&bull; Exercised message queues manipulations etc. to validate infrastructure performance with up-stream and down-stream applications
				</li >
				<li >
				&bull; All projects were executed with ZERO schedule slippage
				</li >
			</ul>
			</div>
