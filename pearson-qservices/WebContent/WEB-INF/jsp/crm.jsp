	...
	<div class="span-24">
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<div class="bar bar-header bar-light" align="right" style="height=0px;">
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						<input type="hidden" name="service" value="CRM" /> 
						<input type="hidden" name="serviceID" value="CRM04" /> 
		...
		<div class="span-24">
			...
			<ul >
				<li >
				&bull; End-to-end functionality validation including different types of profiles, access controls, validation rules and workflow rules 
				
				</li >
				<li >
				 &bull; Validation of fields, functions, conditional parameters, data refresh and filters for customized reports based on business needs
				 
				</li>
				<li >
				&bull;  Data validation in SFDC application during transformation of data from source to target system 
				
				</li >
				<li >
				&bull;  Object, field, and record level security validation using automation
				
				</li >
				<li >
				&bull;  UI validation of multiple browsers (Mozilla, Safari ,IE8 etc.)based on W3 standards & information delivered on secure channel
				
				</li >
				<li >
				&bull;  Post Go-live (PGL) Support/Maintenance
				</li >
			</ul>
			...
			<ul >
				<li >
				&bull; Customer-driven organizations to offer services in a timely and efficient fashion
				
				</li >
				<li >
				&bull; Applications demanding seamless data flow between up-stream and down-stream systems / applications
				
				</li >
				<li >
				&bull; Automation of salesforce object testing for business using salesforce portals and other objects on a continuous basis
			...
			<ul >
				<li >
				&bull;  Rally software defect and test management tool for agile test methodology and management
				
				</li >
				<li >
				&bull;  QTP for recognition of SFDC objects in automation of salesforce objects testing
				...
				<li >
				&bull;  Datahub and Salesforce integration for seamless data transfer between Datahub and SFDC
				
				</li >
				<li >
				&bull;  ESB and Salesforce integration for seamless data transfer
				
				</li >
				<li >
				&bull;  ICOM established standards and frameworks across people, process, and data.
			...
			<ul>
			    <li >
				&bull; Delivered 20 sprints with quality deliverables with in defined timeline
				
				</li >
				  <li >
				&bull; ZERO defect slippage to production
				...
				&bull; Standardized defect management and click stream level test case creation process
				  ...
				  <li >
				&bull; Created reusable knowledge bank for Oracle ERP, Data Hub, ESB, Cameleon and SFDC
				
				</li >
				</li >
				  <li >
				&bull; Ensured the end to end testing( Oracle ERP -> Data Hub -> Cameleon -> SFDC <-> ESB <-> Oracle ERP)
...
<%-- 			<div class="footer">
				...
				<div class="span-8">
					...
					<div class="footer_text">
						<p>&copy; Copy Rights 2014</a> &nbsp;&nbsp; | &nbsp;&nbsp;Pearson Q-service Team. <a href="#"> </a>
						</p>
					</div>
					<!--footer_text close-->
