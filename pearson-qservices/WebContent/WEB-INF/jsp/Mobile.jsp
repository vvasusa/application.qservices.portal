...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="service" value="MOBILE TESTING" /> 
						<input type="hidden" name="serviceID" value="MT06" /> 
		...
		<div class="span-24">
		<H1 style="color:#900000">Mobile Testing</H1>
			
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>

	
	<p > Prepare detailed Test plans & Strategy targeting mobile platforms
			including MECE traceability to provide end-to-end mobile testing
			solution that is scalable and portable.<br>Functional and performance
			testing of mobile application using various scenarios based on the
			respective specifications.<br>Manual verification of the interfaces of
			the mobile app with the given requirements.<br>Usability testing to
			validate stability of the mobile app when there are interrupts from
			other applications.</p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
	<p> Rally to cover end to end agile test methodology -
		Requirments,agile tracking, design,execution, defect tracking and
		reporting and for creation of customized dashboards.<br>Eggplant device
		automation cloud to reduce the effort of cross-device and
		cross-platform mobile software testing (Ex: One script for all devices
		and all platforms).<br>Salesforce customer issue management.</p>
...
<h2 style="color:#3399FF">Project Names where services were offered</h2>
	<p> 1. CCSOC - Common Core school standards to mobile<br> 2. MyApprovals 3.
		Blink</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
	<p>1.CCSOC allows students to have a self sufficient mobile
		learning platform or as an aide to existing methods by incorporating
		or utilizing common core standards.<br>2. MyApprovals allows employees to
		submit expenses and managers can approve expenses using a mobile
		device.
</p>
