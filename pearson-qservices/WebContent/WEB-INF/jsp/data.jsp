...
<body>
	...
	<div class="span-24">
        ...
        <ul id="sub-nav">
            ...
            <li><a href="${pageContext.request.contextPath}/data/"></a>	</li>	 
            </ul>
            </div>
...
<!-- 			<div class="span-9 last">
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<div class="bar bar-header bar-light" align="right" style="height=10px;"E>
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						...
						<input type="hidden" name="serviceID" value="DT05" /> 
		...
		<h2 style="color: black">Data</h2>
			<p>	
				<font size="2px" >
				Assurance that applications and solutions hosted ON the Cloud, FOR the Cloud are functioning as expected by adopting the right tools, techniques and frameworks				</font>
			</p>

			<h3 class="myNewStyle" style="color: #3399FF">Key Features Offerings</h3>
			<ul >
				<li >
				&bull; Define strategy to standardize test data creation and maintenance processes to improve data quality and re-usability factor
				
				</li >
				<li >
				 &bull; Verification of master data flow which includes verification of initial load and change data
				 
				</li>
				<li >
				&bull;  Extraction of data from source system to physical layer
				
				</li >
				<li >
				&bull;  Verification of transformation of data from Physical layer to canonical layer as per mapping documents
				
				</li >
				<li >
				&bull;  Verification of transformation of data from canonical layer to Application layers (Consumers)
			...
			<ul >
				<li >
				&bull; Addressing the data quality challenges involving complex logic for consolidating data from disparate sources
				
				</li >
				<li >
				&bull; Transfer of data from legacy database applications to the newer database applications
				
				</li >
				<li >
				&bull; Data consolidation and replication across multiple databases
				
				</li >
				<li >
				&bull; Ensure production like data availability for tests by scrubbing, replicating, backup, update etc. through appropriate management measures to avoid accidental update and deletion of production data
			...
			<ul >
				<li >
				&bull;  Composite studio data Virtualization Platform to bring data together from multiple, disparate sources into a unified, logical virtualized data layer 
				
				</li >
				<li >
				&bull;  SQL developer to test connections between multiple databases and schemas
				
				</li >
				<li >
				&bull;  Flexible Framework for Handling for handling Semi-structured Data
				
				</li >
				</li >
				<li >
				&bull;  DataGen for Synthetic Data Needs
			...
			<ul>
			    <li >
				&bull; Certified integration API that has been designed to provide a single point of discovery over Pearson assets from a variety of Pearson repositories such as Documentum, Equella Chorus and Asset Library that makes them all searchable through a single search API
				
				</li >
				  <li >
				&bull; Ensured the Data Integrity across the systems by scripting and employing complex queries
