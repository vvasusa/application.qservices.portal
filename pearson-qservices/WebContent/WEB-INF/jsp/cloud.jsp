...
<body>
	...
	<div class="span-24">
    	...
    	<ul id="sub-nav">	
    		<li><a href="${pageContext.request.contextPath}/services/">Service Catalog</a>	</li>       
			<li><a href="${pageContext.request.contextPath}/cloud/"></a></li>	
   </ul>
  </div>  
 </div>
	...
	<%-- 	<div class="page">
		...
		<div class="span-24">
			...
			<ul >
				<li >
				&bull; Validating FOR the Cloud to address NFRs with cloud solutions such as performance and scalability of the cloud app across geographies, data centers, etc.
				</li >
				<li style="list-style:default;">
				 &bull; Validating ON the Cloud by providing testing solutions to our customers using various cloud architectures to ensure they maintain functionality, data integrity, security and privacy
				</li>
				<li >
				&bull;  Validating of apps deployed on hybrid or community clouds
				</li >
				<li >
				&bull;  Validating the cloud-migration of applications, platforms and databases
				</li >
				<li >
				&bull;  Validation against SLA, regulatory compliance, Enterprise policy compliance, security & other non-functional requirements
				</li >
			</ul>
			...
			<ul >
				<li >
				&bull; System or application functionality is working as expected when deployed using a cloud solution
				</li >
				<li >
				&bull; Functionality is not affected when deployed on a hybrid or community clouds
				</li >
				<li >
				&bull; Applications which are dynamic, complex, distributed and component-based
				</li >
				<li >
				&bull; Systems with more interfaces (connections) to other systems and mission-critical systems are migrated successfully
				</li >
			</ul>
			...
			<ul >
				<li >
				&bull;  Cloud based performance testing tools such as: Keynote, Soasta, Monitis, Cloudslueth, BrowserMob, GFI, LoadStorm, InterMapper
				</li >
				<li >
				&bull;  Cloud based Security testing tools such as IBM AppScan, WebInspect, Acunetix WVS and Burp Suite
				</li >
				<li >
				&bull;  open source cloud based security testing tools such as IronWASP,W3AF and Acunetix Free Edition
				</li >
			...
			<ul>
			    <li >
				&bull; Provided various quality services for various Cloud Services programs like GSE, ARM, myStack etc.
				</li >
				  <li >
				&bull; Completed security scans for 90 applications in ARM program and provided exhaustive reports to application owners to progress to next logical gate
				</li >
				  <li >
				&bull; Investigated issues related to Qualys Data Quality, PCAT / MAT remediation and provided recommendations 
				</li >
				  <li >
				&bull; Provided functional, automation, security and performances services and delivering the projects with no schedule or defect slippage
				</li >
			</ul>
