...
<body>
	...
	<div class="container">
        ...
        <ul id="sub-nav">
			...
			<li><a href="${pageContext.request.contextPath}/online/"></a>	</li>	
			</ul>
			</div>
...
<%-- 			<div class="span-14 colborder">
 ...
 --%>
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						<input type="hidden" name="service" value="Online" /> 
						<input type="hidden" name="serviceID" value="ON11" /> 
		...
		<div class="span-24">
			...
			<p>	
				Enhance Learner's online experience of web-applications, eCommerce, Content etc. by assuring functionality, availability and usability to support the growing volume of business
			</p>

			<h3 class="myNewStyle" style="color: #3399FF">Key Features Offerings</h3>
			<ul >
				<li >
				&bull; Creating reusable test scenarios, customizable business transaction libraries and planning a standard QA strategy to accelerate functional test cycles 
				
				</li >
				<li >
				 &bull; Graphical user interfaces are validated to ensure specific requirements for navigation, look and feel, and general site operation are satisfied.
				 
				</li>
				<li >
				&bull;  Cross Browser/OS testing to ensure compatibility of websites
				
				</li >
				<li >
				&bull;  Accessibility testing to ensure websites meet Web Content Accessibility Guidelines 
				
				</li >
				<li >
				&bull;  	Comprehensive end to end flow testing to check the system behavior with multiple concurrent configurations by verifying external modules such as payment systems (WebMoney, PayPal, Vertex, Cortex and other third party systems)
				</li >
				<li >
				&bull;  Detailed Content Management system testing from both Authoring and Publishing environments to ensure business users have the flexibility to create/change the websites' look and feel in real time
			...
			<ul >
				<li >
				&bull; Assure business and executive management about the quality and health of revenue generating, eCommerce, web-applications etc. before the production launch
				
				</li >
				<li >
				&bull; Person's brand is preserved as well as improved resulting in increased number of end users
			...
			<ul >
				<li >
				&bull;  ADPART, CRAFT which help in automating test design and execution
				
				</li >
				<li >
				&bull;  Integration of Craft+Selenium (open source automated testing tool) to Create reusable automated frameworks for Continuous Integration
				
				</li >
				<li >
				&bull;  Adobe-CQ content management system to manage incredible amounts of information
				
				</li >
				<li >
				&bull;  Customized QA framework aligned with PDLC's Agile and Waterfall guidelines
			...
			<ul>
				...
				&bull; Customized QA framework aligned with PDLC's Agile and Waterfall guidelines
				  ...
				  <li >
				&bull; Created reusable Adobe-CQ Test Case Bank which resulted in a 30% reduction of QA effort
				
				</li >
				  <li >
				&bull; Automated test execution & Continuous Integration with build management system
				
				</li >
				  <li >
				&bull; Standardized defect management and click stream level test case creation process
				
				</li >
				 <li >
				&bull; Created reusable knowledge bank for Adobe CQ, SOLR (search engine) and PMDB (data base)
				</li >
			</ul>
