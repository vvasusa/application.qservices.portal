...
<script type='text/javascript' src='http://getfirebug.com/releases/lite/1.4/firebug-lite-compressed.js'></script>
	...
	<div class="span-24">
		<div class="span-10">
			...
			<ul id="navigation">
				...
				<li><a href="${pageContext.request.contextPath}/requestList/" id="port_front" title="Request"><span>Request</span></a></li>
