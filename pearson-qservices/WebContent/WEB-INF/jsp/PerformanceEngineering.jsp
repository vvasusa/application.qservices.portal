...
<div class="span-24">
<H1 style="color:#900000">Performance Engineering</H1>
	
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>


<p > 
	Focus on NFR principles while performing static code reviews, dynamic code profiling and early performance engineering at unit or component level. <br>
Recommend and implement best practices in database design, capacity planning and overall architecture of the system to improve performance. <br>
Analyze performance test results and recommend or implement fixes to improve the performance of the system.<br>
Identify root causes of application performance bottlenecks to fix performance issues.<br>
Provide value add to Database Design to improve performance of the system.<br>
Provide inputs during capacity planning activity to reduce costs. </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
<p> New Service Offering. Hence not applicable<br></p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
<p> Applications in which restrictions in scaling to large peak load or restriction in quick execution of tests are observed. <br> Performance engineering for identifying performance bottlenecks early in the development lifecycle for business critical applications .
</p>
