...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="service" value="DATAINTEGRATION" /> 
						<input type="hidden" name="serviceID" value="DI04" /> 
		...
		<div class="span-24">
		<H1 style="color:#900000">DateIntegration Testing</H1>
			
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>

	
	<p >  Verification of master data flow which includes verification of
			Initial load and change data.<br> Extraction of Data from source
			system to physical layer.<br>Verification of Transformation of data
			from Physical layer to canonical layer as per mapping documents.<br>
			Verification of Transformation of data from canonical layer to
			Application layers (Consumers).<br> End to End testing of data flow
			which includes Application API testing. </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
	<p> Composite studio is a data Virtualization Platform used to bring
		data together from multiple, disparate sources into a unified, logical
		virtualized data layer.<br> SQL developer is used to test connections
		between multiple databases and schemas.</p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
	<p>	Addressing the data quality challenges such complex logic for
		consolidating data from disparate sources, data quality problems in
		source systems.<br> Transfer of data from the databases of legacy
		applications to the databases of newer applications.<br>Data
		consolidation in merger and acquisitions.<br>Data replication across
		multiple databases.
		</p>

<h2 style="color:#3399FF">Project Names where services were offered</h2>
	<p> 1. CHASKI <br>2. ICOM <br>3. APAC Integration<br> 4. One Oracle</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
	<p>1.Web service testing using SOAP UI tool for CHASKI project
		has been highlighted in a very good way as such different services
		(api) had been tested individually and also integration testing as a
		CHASKI API.<br>2. Ensuring the Data Integrity across the systems by using
		complex Queries and Test data preparation was one of the challenging
		tasks for ICOM 1.3.
</p>
