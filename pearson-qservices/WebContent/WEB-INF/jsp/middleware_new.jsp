...
<body>
	...
	<font face="verdana ,helvetica"  size="2" color="#990066" >
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						<input type="hidden" name="service" value="MIDDLEWARE" /> 
						<input type="hidden" name="serviceID" value="MI09" /> 
		...
		<!-- ******************************************************************************** -->
		<div class="span-24">
			<p>	<h2 style="color: black">Middleware</h2>
				<font size="2px" >
			...
			<ul >
				<li >
				&bull; Comprehensive test methodology to validate middleware components, functionality and integration points with up-stream and down-stream applications across heterogeneous platforms
				
				</li >
				<li >
				 &bull; Identify performance bottlenecks within the middleware architecture and provide recommendations in order to optimize performance and ensure scalability
				 
				</li>
				<li >
				&bull;  Perform Load testing to determine the handling capacity of ESB 
				
				</li >
				<li >
				&bull;  Perform co-existence testing to validate proper functioning of new ESB with the existing ESB infrastructure
				
				</li >
				<li >
				&bull;  Repeatable and manageable middleware integration tests to validate the stability of middleware integrations
			...
			<ul >
				<li >
				&bull; Systems encountering frequent performance bottlenecks and connectivity issues due to complex middleware architecture 
				
				</li >
				<li >
				&bull; Complex and distributed applications having limited lifespan
			...
			<ul >
				<li >
				&bull;  IBM Websphere Message Broker for business information flow between disparate applications across multiple hardware and software platforms
				
				</li >
				<li >
				&bull;  RFHUtil for accelerating middleware testing 
				
				</li >
				<li >
				&bull;  SoapUI web services tool for automated functional testing 
				
				</li >
				<li >
				&bull;  LoadUI API for interactive & real-time load test creation and redistribution
				</li >
			...
			<ul>
			    <li >
				&bull; Validated and certified several interfaces in APAC integration project to assure proper functioning of the existing ESB infrastructure
				
				</li >
				  <li >
				&bull; Performed load testing of interfaces in QA environment to validate the handling capacity
				
				</li >
				  <li >
				&bull; Leveraged SOAP UI tool to access API(web services) for retrieving metadata and resources to validate Pearson assets by authoring multiple complex queries
