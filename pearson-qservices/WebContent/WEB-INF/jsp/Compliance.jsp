...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="serviceID" value="CT12" /> 
...
<div class="span-24">
<H1 style="color:#900000">Compliance Testing</H1>
	
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>


<p > Perform compliance validation for * QMF(Questions-Maintenance-Fix), Enhancements(Polaris process & PDLC) and Non-Key application(Security and Access)<br>
Review and audit of the following:
* In-scope change activity, leveraging standard processes and information sources (e.g., Remedy, Change Point, PDLC (and other established document repositories)<br>
* Non-key application security and access activity, leveraging standard processes and information sources<br>
Control framework setup and maintenance, as required, to support upcoming audit activity schedule<br>
Assessment and formal compliance scoring of in-scope change and non-key security and access activity, using establishing compliance scoring framework.<br>
Compliance results report preparation and distribution to IT Managers (weekly).<br>
Facilitate IT manager review and appeal process through follow-up review/discussion of nonconformance areas.</p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
<p> Change point is the system of record for QMF (Questions, maintenance & Fix) where all SOX artifacts are stored and used for SOX Audits. Change point has Project Time reporting module for Time and effort tracking purpose<br>
Remedy is the infrastructure change management and problem management tracking system. Within the context of QMF activities, its primary use is to record application change management activity at the time the changes are ready for promotion to the production environment. Remedy also provides the approval record for QMF changes to be promoted to production<br>
PDLCis the system of record for PDLC Enhancements â Project details and SOX artifacts are stored and used for SOX Audits<br> Request for Service is the system of record for enhancements and to ensure funding/approvals.<br></p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
<p> These services could be utilized for any other critical Application group with financial impact with-in Pearson Technology.<br>
Assist external auditors to report on the adequacy of the company's internal control on financial reporting.<br>
Formalizing and strengthening internal checks and balances within corporate.<br>
Situations demanding institution of various new levels of control and sign-off to ensure that financial reporting exercises full disclosure.

</p>

<h2 style="color:#3399FF">Project Names where services were offered</h2>
<p> North America application:  <br>
1. SAP EDNA<br>
2. PEUOPS<br>
3. PE Royalties<br>
4. PG Royalties<br>
5. PCS-CES<br>
6. Business Intelligence<br>
7. PRIME (hyperion)</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
<p>1. ~250 Enhancements implemented with zero leakage of defects<br>
2. ~2,000 Break-Fix/Maintenance items implemented with zero leakage of defects<br>
3. Trained Â½ of the applications teams as they reorganized their groups<br>
4. Transitioned from hard-copy evidence audits into soft-copy online evidence.  Resulting in 1 week effort savings during each quarters testing.
</p>
