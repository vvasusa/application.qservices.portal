...
<body>
	...
	<font face="verdana ,helvetica"  size="2" color="#990066" >
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						<input type="hidden" name="service" value="QA PROGRAM" /> 
		...
		<!-- ******************************************************************************** -->
		<div class="span-24">
			<p>	<h2 style="color: black">QA Program Management </h2>
				<font size="2px" >
			...
			<ul >
				<li >
				&bull; Quality consulting partner to support in developing Test estimates, Test Strategy, Test Work Plan, Test Schedule
				
				</li >
				<li >
				 &bull; Provide guidance through testing process, process improvement recommendations to overcome testing challenges
				 
				</li>
				<li >
				&bull;  Provide guidance for defining the quality validation process and quality gates
				
				</li >
				<li >
				&bull;  Assist with activities, deliverables, risks, dependencies associated with testing, as needed
				
				</li >
				
				<li >
				&bull;  Provide templates, checklists, testing artifacts, as needed
				
				</li >
				<li >
				&bull;  Provide packaged solution to optimize QA cost and to drive faster time-to-market
			...
			<ul >
				<li >
				&bull;  Programs / Projects with an objective to build quality management practices to deliver quality product to the market
				
				</li >
				<li >
				&bull;  Experience and leadership to steer the quality goals of the organization / project
				
				</li >
				<li >
				&bull;  Expertise to bring in best practices and standards to achieve quality output
			...
			<ul >
			 <li >
				&bull; Experienced Quality management personnel coupled with Templates, guidelines & checklists to ensure adequate test coverage 
				
				</li >
				  <li >
				&bull; Management team equipped with technical knowledge, accelerators and cost effective tools to automate test design and execution for achieving faster time to market
				
				</li >
				  <li >
				&bull; Usage of effective Risk Management techniques to successfully to deliver projects
				</li >
			...
			<ul>
			   <li >
				&bull; Delivered high quality software by adhering to Pearson QCoE Standard Operating Procedures
				
				</li >
				<li >
				&bull; Provided Project teams access to QCoE Tools and frameworks 
				</li >
				<li >
				&bull; Effective reuse of ROI based QA assets
				</li >
				<li >
				&bull; Multiple projects were delivered with Zero Production Defects
				</li >
				<li >
				&bull; Best Practices employed to achieve the larger goal of Quality output
				</li >
			</ul>
