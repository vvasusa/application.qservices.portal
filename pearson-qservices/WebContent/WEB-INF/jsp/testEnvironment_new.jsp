...
<body>
	...
	<div class="container">
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						<input type="hidden" name="service" value="Environment Management"/> 
						<input type="hidden" name="serviceID" value="EM06" /> 
		...
		<div class="span-24">
			...
			<ul >
				<li >
				&bull; Establish environments for various phases of testing and manage their usage
				
				</li >
				<li >
				 &bull; Create an inventory of available environments on various platforms and ensure timely availability of test environment / data for testing
				 
				</li>
				<li >
				&bull;  Manage existing test environments, build new test environments and provide additional capacity on demand
				
				</li >
				<li >
				&bull;  Establish a testing calendar to communicate and co-ordinate environment availability across different teams
				
				</li >
				<li >
				&bull;  Refresh the environment with production or production-like data on a periodic basis to enable effective testing
			...
			<ul >
				<li >
				&bull; Applications facing frequent environment downtime impacting the timelines
				
				</li >
				<li >
				&bull; Applications or products having defect slippage to production due to mismatch between production, end-customer and test
				
				</li >
				<li >
				&bull; Applications which are highly critical and complex having longer release cycle time
			...
			<ul>
			    <li >
				&bull; Test Environment Management Services (TEMS) a tool agnostic framework helps organizations to achieve efficiencies in demand fulfillment, capacity utilization and environment availability 
				
				</li >
				  <li >
				&bull; Assessment framework driven by gap analysis and roadmap plan to create best TEMS delivery model
				
				</li >
				  <li >
				&bull; Environment management tool to manage environments that provides environment utilization %, scheduling, reallocation, environment requests, etc.
