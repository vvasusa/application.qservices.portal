 ...
 --%>
		...
		<div class="">
			...
			<ul id="navigation"><li><a href="${pageContext.request.contextPath}/index/"	id="home" title="Home"><span>home</span></a></li>
				<li><a href="${pageContext.request.contextPath}/services/"	id="services_front" title="Our Services"><span>services catalog</span></a></li>
...
<%-- 			<div class="span-14 colborder">
 ...
 --%>
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						<input type="hidden" name="service" value="Security" /> 
						<input type="hidden" name="serviceID" value="SU15" /> 
		...
		<h3></h3>
			<p>	
				<font size="2px" >
				Validation of security vulnerabilities for applications or platforms which assure Learner and End-User data integrity and compliance to standards
			...
			<ul >
				<li >
				&bull; Leverage software testing frameworks and techniques to identify application security vulnerabilities, weaknesses and concerns related to authentication, input/output validation, processing errors, denial of service etc. 
				
				</li >
				<li>
				 &bull; Discover and remediate security lapses to ensure that the security requirements are met within the Pearson application landscape.
				 
				</li>
				<li >
				&bull;  Identify scenarios where the application fails, behaves abnormally and can withstand the attack/exploit
				
				</li >
				<li >
				&bull;  End-to-end validation approach incorporating various elements of application security across all stages of the software development life cycle (SDLC) to enhance customer confidence
				
				</li >
				<li >
				&bull;  Implementation of the Data Classification Level assignment system and ARM system for Pearson applications
			...
			<ul >
				<li >
				&bull; Applications which are vulnerable to attacks such as hacking the system or logging into the application without any authorization. 
				
				</li >
				<li >
				&bull; Identify all potential loopholes and weaknesses in the application at the earliest and collaborate with the development team to fix them
				
				</li >
				<li >
				&bull; Publically available system lacking secure environment
			...
			<ul >
				<li >
				&bull;  Adoption of CVE, SANS, CVSS and OWASP (Open Web Application Security Project) manual Industry standards and guidelines 
				
				</li >
				<li >
				&bull;  Qualys to check network, servers, desktops or web apps for security vulnerabilities
				
				</li >
				<li >
				&bull;  IBM AppScan to automate testing of REST-based services 
				
				</li >
				<li >
				&bull;  Unified Vulnerability Management system for tracking Qualys, AppScan and Compliance vulnerabilities
				
				</li >
				<li >
				&bull;  Unified Security testing framework for Pearson security testing
			...
			<ul>
			    <li >
				&bull; Developed customized scripts to import AppScan results into the Vulnerability Management tracker
				
				</li >
				  <li >
				&bull; Provided CVSS Rating to cognize the severity and impact of the vulnerability
				
				</li >
				  <li >
				&bull; Highlighted the risks associated with the application based on the vulnerabilities identified
				
				</li >
				  <li >
				&bull; Provided guidance to the development team to understand the security threat factors and track the issues to closure
				
				</li >
				 <li >
				&bull; Provided detailed recommendations to fix the vulnerabilities at the earliest
