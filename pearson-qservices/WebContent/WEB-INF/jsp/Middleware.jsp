...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="serviceID" value="ME03" /> 
		...
		<div class="span-24">
		<H1 style="color:#900000">MiddleWare/ESB Testing</H1>
			
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>

	
	<p > 
			Comprehensive test methodology to deliver component, functional
			and integration testing of the middleware layer to provide effective
			communication across heterogeneous platforms<br>Identify performance
			bottlenecks within the middleware architecture and provide solutions
			in order to optimize performance and ensure scalability.<br>Perfom
			Load testing to determine the handling capacity of ESB<br>Perform
			co-existence testing to ensure proper functioning of ESB with the
			existing ESB infrastructure. <br> Repeatable and manageable middleware
			integration tests to validate the stability of Pearson's middleware
			integrations. </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
	<p> IBM Websphere Message Broker allows business information to flow
		between disparate applications across multiple hardware and software
		platforms.<br>RFHUtil is a utility program that helps in accelerating
		middleware testing by allowing a wide variety of message manipulations
		.<br>SoapUI is used to create advanced Performance Tests and to run
		Automated Functional Tests.<br> LoadUI is an API load testing solution
		that allows creation, configuration and redistribution of the Load
		tests interactively and in real-time.<br></p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
	<p> Systems encountering frequent performance bottlenecks and
		onnectivity issues due to complex middleware architecture.<br>Complex
		and distributed applications having limited lifespan.
		</p>

<h2 style="color:#3399FF">Project Names where services were offered</h2>
	<p> 1. CHASKI <br> 2. APAC Integration<br> 3. ICOM<br> 4. SII <br>5. One Oracle</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
	<p>1. Performed functional testing of 7 interfaces in APAC
		integration projects.<br>2. Performed load testing of 7 interfaces in QA
		environment.
</p>
