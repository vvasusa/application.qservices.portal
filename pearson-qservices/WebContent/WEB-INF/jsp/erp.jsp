	...
	<div class="container">
        ...
        <ul id="sub-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath}/services/">Service Catalog</a></li>
                    	<li><a href="${pageContext.request.contextPath}/erp/"></a></li>	
</ul>
</div>
		...
		<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form action="${pageContext.servletContext.contextPath}/raiseRequest/"	method="post" commandName="requestForm">
						<input type="hidden" name="service" value="Erp" /> 
						<input type="hidden" name="serviceID" value="ER07" /> 
		...
		<div class="span-24">
			<hr class="space" />
			 <h2 style="color: black">ERP</h2>
			<p>
				Validate ERP implementations, configurations and customizations to meet business needs in terms of functionality, performance, and scalability
				</p>
			<h3 class="myNewStyle" style="color: #3399FF">Key Features Offerings</h3>
			<ul >
				<li >
				&bull; Provide domain & business process expertise to ensure that all business features and processes are functioning as expected
				</li >
				<li >
				 &bull; Performance testing to validate high data flow and demanding transactions of the ERP system is as per the system engineering requirements
				</li>
				<li >
				&bull;  Integration testing with up-stream and down-stream applications to validate end to end business functionality of the ERP package is as per the requirements
				</li >
				<li >
				&bull;  Adoption of a mix of automated and manual tests to test adequately for ensuring the overall implementation
				</li >
			...
			<ul >
				<li >
				&bull; Multi-geography projects requiring deeper and wider levels of enterprise-level test management experience
				
				</li >
				<li >
				&bull; Interim market releases and software upgrades that require continuous testing, modeling of relevant business scenarios as an integrated suite
				
				</li >
				<li >
				&bull; Industries in which compliance and regulatory requirements have high priority
				
				</li >
				<li >
				&bull; Validation of customizations for large implementations
			...
			<ul >
				<li >
				&bull;  QMetry and JIRA integration as a full test and defect management tool
				
				</li >
				<li >
				&bull;  SOARS test repository to store test scripts authored for various sub-modules. It helps in reducing time to market by making the test scripts readily available
				
				</li >
				<li >
				&bull;  RAPIDO and CRAFT automation framework to create, execute and maintain automated tests
			...
			<ul>
			    <li >
				&bull; Ensured test coverage by covering critical business process flows and system requirements
				
				</li >
				  <li >
				&bull; End to End functionality testing when Oracle ERP application and non-Oracle ERP applications are integrated
				
				</li >
				  <li >
				&bull; Validated all customized functions and RICEWS components to meet function design and system requirement 
				
				</li >
				  <li >
				&bull; Performed thorough tests to validate ERP processes like Order-to-Cash (OTC), Requisition to Check (PO Requisition-->Purchase order, Receipt of good, invoice for goods) and Finance
				
				</li >
				 <li >
				&bull; Prepared reusable test scenarios and test cases for most commonly used functionality
