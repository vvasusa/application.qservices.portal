...
<c:if test="${!empty loginType}">
			<c:if test="${loginType=='VISITOR'}">
					...
					<form
						...
						<input type="hidden" name="service" value="ORACLE ERP" /> 
						<input type="hidden" name="serviceID" value="OT08" /> 
		...
		<div class="span-24">
		<H1 style="color:#900000">Oracle ERP Testing</H1>
			
<h2 class="myNewStyle" style="color:#3399FF">  Key Features Offerings </h2>

	
	<p > Provide domain & business process expertise allowing functional testing to ensure that all business features are tested, including the software and hardware involved in running the ERP modules.<br>Performance testing to validate high data flow and demanding transactions of the ERP system
.<br> Integration testing to perform business scenario validation of  the ERP package
.<br>Validation throughout the lifecycle of Oracle ERP programs such as  implementation, rollout, upgrade, production support and maintenance to deliver quality, speed and cost effectiveness. </p>


<h2 style="color:#3399FF">Tools & Accelerators</h2>
	<p> SOARS is a test repository which is used to store test scripts authored for various sub-modules. 
	It helps in reducing time to market by making the test scripts readily avaialble.</p>

<h2 style="color:#3399FF">Where this service would be benefiting</h2>
	<p> Multi-geography projects requiring deeper and wider levels of enterprise-level test management experience
.<br>Interim market releases and software upgrades that require continuous testing, modeling of relevant business scenarios as an integrated suite of automated test cases.<br>
Industries in which compliance and regulatory requirements have high priority
.<br>At the time of implementation we can reuse the test scripts which we prepared for functional system testing.
.<br>In future, whenever any patch applied or defect fixed then we can take this take to test those changes.
.<br>In future in any rollout of oracle EBS in other countries then we can reuse these functional, system, regression and automations scripts.
		</p>

<h2 style="color:#3399FF">Project Names where services were offered</h2>
	<p> 1. AMS Oracle(Maintenance support and QA)<br>
2. One Oracle(Implementation)</p>

<h2 style="color:#3399FF">Key Highlights from Projects Executed</h2>
	<p>1. Deliver in a complex, dynamic environment with business demands, requirements & priorities<br>
2. Drive lower cost for rollout.
</p>
